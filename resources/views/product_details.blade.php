                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    @foreach (explode(',', $product->images) as $gimage)
                                        <div class="swiper-slide product-single__image-item">
                                            <img loading="lazy" class="h-auto"
                                                src="{{ asset('uploads/products/thumbmails/' . $gimage) }}" width="674"
                                                height="674" alt="" />
                                            <a data-fancybox="gallery"
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                                            src="{{ asset('uploads/products/thumbmails/' . $product->image) }}" width="104" height="104"
                                            alt="" /></div>

                                            @foreach (explode(',',$product->images) as $gimge )
                                            <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                                                src="{{ asset('uploads/products/thumbmails/' . $gimge) }}" width="104" height="104"
                                                alt="" /></div>
                                            @endforeach
