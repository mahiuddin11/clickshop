...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }}</title>
        ...
        <meta name="author" content="Click Collect" />
        ...
        <link rel="shortcut icon" href="{{asset('assets/images/clicklogo.png')}}">
        <link rel="apple-touch-icon-precomposed" href="{{asset('assets/images/clicklogo.png')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('adminassets/css/sweetalert.min.css')}}">
...
<body class="body">
                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{route('admin.index')}}" id="site-logo-inner">
                            <img class="" id="logo_header" alt="" src="{{asset('assets/images/clicklogo.png')}}"
                                data-light="{{asset('assets/images/clicklogo.png')}}" data-dark="{{asset("assets/images/clicklogo.png")}}">
                        </a>
                            ...
                            <ul class="menu-list">
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.productlist')}}" class="">
                                                <div class="text">Products</div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.catagories.add')}}" class="">
                                                <div class="text">New Category</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.catagoris')}}" class="">
                ...
                <div class="section-content-right">
                                        ...
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                ...
                                                <span class="flex flex-column">
                                                    ...
                                                    <span class="text-tiny">{{Auth::user()->user_type }}</span>
                                                </span>
                                            </span>
                                        </button>
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2024 Click Collect</div>
                        </div>
                    </div>
    ...
    <script src="{{asset('adminassets/js/sweetalert.min.js')}}"></script>
